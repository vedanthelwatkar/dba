        ...
        <div className="bg-nyghtserif px-10 flex flex-col gap-4 justify-center items-center py-8 sm:py-[60px] md:px-20 lg:rounded-lg">
          <div className="max-w-[700px] flex flex-col gap-4 justify-center items-center ">
            ...
            <span className="text-body-lg text-neutral-100 text-center">
              At Designs By Abhishek, transparency and trust are at the heart of
      ...
      <div className="p-5 pb-10 md:p-10 md:pb-20 lg:p-20 lg:pt-5">
        <div className="flex items-center justify-center w-full">
          <div className="flex flex-col gap-4 text-neutral-700 text-body-lg justify-self-center max-w-[800px]">
            ...
            <p>
              We are Designs By Abhishek Private Limited ("Company," "we," "us,"
              "our"), a company registered in India at 1st Floor, Modi House,
              Off Link Rd, Near Fun Republic, Mumbai, Maharashtra, 400053.
            </p>
            <p>
            ...
            <p>
              ...
              designsbyabhishek@gmail.com, or by mail to ALTF plot no. 21, 21A,
              Sector 142, Gautam Budh Nagar, Uttar Pradesh 201304, India.
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity ("you"),
              and Designs By Abhishek Private Limited, concerning your access to
            ...
            <ol className="list-decimal list-inside text-system-info-600 cursor-pointer">
              ...
              <li onClick={() => scrollToSection("section22")}>
                MISCELLANEOUS
              </li>
            ...
            >
              ...
              <p>
                ...
                designsbyabhishek@gmail.com. If we ever grant you the permission
            ...
            >
              ...
              <p>
                ...
                Privacy Policy:{" "}
                <a
                  href="http://designsbyabhishek.com/privacy-policy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-system-info-600"
                >
                  http://designsbyabhishek.com/privacy-policy
                </a>
            ...
            >
              ...
              <p>
                ...
                laws of India. Designs By Abhishek Private Limited and yourself
            ...
            >
              ...
              <p>
                ...
                place, or arbitration shall be Mumbai, India. The language of
            ...
            >
              ...
              <p>
                ...
                arising out of: (1) your use of the Services; (2) breach of
            ...
            >
              ...
              <p>
                ...
                communications, please email us at designsbyabhishek@gmail.com
                or call at +91 81787 59588.
              </p>
            </div>
            ...
            >
              ...
              <p>
                Designs By Abhishek Private Limited
                <br />
                1st Floor, Modi House, Off Link Rd, Near Fun Republic, Mumbai,
                400053
                <br />
                Maharashtra
                <br />
